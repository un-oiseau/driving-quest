        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                ...
                <?php $badge1 = get_field('badge_1');?>
                    <?php if ($badge1 ) :  ?>
                        <img src="<?php echo $badge1 ['url']; ?>" alt="<?php echo $badge1 ['alt']; ?>" title="<?php echo $badge1['title']; ?>">
                    <?php endif; ?>
                <span><?php echo get_field('text_2');?></span>
                <?php echo get_field('content');?>
                <?php $badge2 = get_field('badge_2');?>
                    <?php if ($badge2 ) :  ?>
                        <img src="<?php echo $badge2 ['url']; ?>" alt="<?php echo $badge2 ['alt']; ?>" title="<?php echo $badge2['title']; ?>">
                    <?php endif; ?>
