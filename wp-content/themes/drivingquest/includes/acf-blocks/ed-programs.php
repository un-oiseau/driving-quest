...
<div class="<?php echo esc_attr($classname) ?>">
    <div class="container-small container-sm">
        ...
        <div class="row">
            <div class="ed-card col-lg-4 col-md-12" data-target="#d-card-1">
            ...
            <div class="ed-card col-lg-4 col-md-12" data-target="#d-card-2">
            ...
            <div class="ed-card col-lg-4 col-md-12" data-target="#d-card-3">
    ...
    <div class="single-card container-md">
        <?php $arrow = get_field('arrow'); ?>
            ...
            <?php endif; ?>
        <?php for ($i = 0; $i < count($d_cards); $i++): $single = $d_cards[$i]['how_it_works']; ?>
            <div class="display-card card" id="d-card-<?php echo $i+1; ?>">
                <div class="row">
                    <div class="col-12">
                            <div class="card-body">
                                <div class="card-body-row row">
                                    ...
                                    <div class="col-lg-4 col-sm-12 display-card-block-middle">
                                    ...
                                    <div class="col-lg-5 col-sm-12 display-card-block-last">
